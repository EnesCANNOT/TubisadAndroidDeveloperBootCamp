...
public class FragmentCartBindingImpl extends FragmentCartBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.cartFragmentObject == variableId) {
            setCartFragmentObject((com.helloworldstudios.yemekgetir.CartFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCartFragmentObject(@Nullable com.helloworldstudios.yemekgetir.CartFragment CartFragmentObject) {
        this.mCartFragmentObject = CartFragmentObject;
    }
    ...
    /* flag mapping
        flag 0 (0x1L): cartFragmentObject
        flag 1 (0x2L): null
    flag mapping end*/
    //end
}