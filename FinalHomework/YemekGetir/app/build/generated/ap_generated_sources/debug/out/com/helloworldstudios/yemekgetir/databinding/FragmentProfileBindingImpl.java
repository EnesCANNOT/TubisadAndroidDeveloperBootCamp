...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.profileFragmentObject == variableId) {
            setProfileFragmentObject((com.helloworldstudios.yemekgetir.ProfileFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setProfileFragmentObject(@Nullable com.helloworldstudios.yemekgetir.ProfileFragment ProfileFragmentObject) {
        this.mProfileFragmentObject = ProfileFragmentObject;
    }
    ...
    /* flag mapping
        flag 0 (0x1L): profileFragmentObject
        flag 1 (0x2L): null
    flag mapping end*/
    //end
}